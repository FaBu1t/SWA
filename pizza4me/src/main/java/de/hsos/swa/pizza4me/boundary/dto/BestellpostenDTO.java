...
public class BestellpostenDTO {
    ...
    public BestellpostenDTO(int id, int menge, PizzaDTO pizzaDTO) {
        this.menge = menge;
    ...
    public static class Converter {
        public static BestellpostenDTO toBestellpostenDTO(Bestellposten bestellposten) {
            BestellpostenDTO retBestellpostenDTO = new BestellpostenDTO(bestellposten.getMenge(),
                    PizzaDTO.Converter.toPizzaDTO(bestellposten.getPizza()));
